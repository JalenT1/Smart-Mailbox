...
Run mailbox_pub.py script again to test the email alert system. You should receive an email alert shortly after running the script. Users will be notified after every state change of the system. 
## Demo Video
